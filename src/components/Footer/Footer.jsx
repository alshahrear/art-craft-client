...
const Footer = () => {
    return (
        <div>
            <footer className="flex justify-evenly footer bg-[#0f142b]  text-white p-10">
                <aside>
                    <div className="space-y-4">
                        <img src={logo} alt="" />
                        <p>Providing reliable tech since 1992 and still develop.</p>
                        <p className="flex items-center hover:link"><span className="mr-2"><MdOutlineMail></MdOutlineMail></span> artse@artseInfo.com</p>
            ...
            <footer className="footer bg-[#141a33] flex py-5 justify-center items-center">
                <aside className="">
                    <p className="text-xl text-white font-medium">Copyright © {new Date().getFullYear()} by <span className="text-[#b1f315]">Artse</span>  - All right reserved </p>
                </aside>
            </footer>
        </div>
    );
